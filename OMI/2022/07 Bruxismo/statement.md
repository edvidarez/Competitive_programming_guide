...
- $1 \leq N \leq 2.5 \times 10^5$ El número de dientes de Fernanda.
- $1 \leq T \leq 10^4$ El número de días para los que se conoce la fuerza con que apretará Fernanda.
- $1 \leq A_i, B_i \leq 15$ El daño y la recuperación diaria de el $i-ésimo$ diente.
...
- (5 puntos): $N = 10$, $T = 1$. Sólo se requiere evaluar una noche.
- (17 puntos): $N, T \leq 1000$.
- (22 puntos): $D_i = D_j$, $A_i = A_j$ y $B_i = B_j$ Todos los dientes tienen la misma dureza, sufren el mismo daño diario y tienen la misma recuperación.
- (26 puntos): $A_i = B_i$ Para todos los dientes el daño diario es igual a su recuperación.
