...
Si durante la ejecución de tu programa execede el límite de llamadas permitidas a `Preguntar`, recibirás 0 puntos.
Si al finalizar la ejecución de tu solución no encontraste al chico cool, y hay un chico cool en la fiesta, tu puntaje será de 0 puntos.
Por otro lado, si encontraste al chico cool sin haber excedido el límite de llamadas permitidas y tu función no excede el límite de tiempo obtendrás el 100% de los puntos.
